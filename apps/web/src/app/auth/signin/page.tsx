...
export default function SignInPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (result.ok) {
      // Get user data from auth context after signin
      // The user object will be updated by the signIn function
      // For now, just redirect to dashboard - we'll add mode-based routing later
